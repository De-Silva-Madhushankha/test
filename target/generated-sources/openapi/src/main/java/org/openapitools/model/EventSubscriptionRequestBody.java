...
import org.openapitools.model.EventSubscriptionRequest;
...
public class EventSubscriptionRequestBody {
   ...
   */
  public EventSubscriptionRequestBody(String requestId, EventSubscriptionRequest data) {
  ...
  */
  ...
  @JsonProperty("data")
  public EventSubscriptionRequest getData() {
    return data;
  }
