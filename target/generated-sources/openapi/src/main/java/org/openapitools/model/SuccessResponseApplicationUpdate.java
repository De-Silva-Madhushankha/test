...
public class SuccessResponseApplicationUpdate implements Response200ForApplicationUpdate {
   ...
   */
  public SuccessResponseApplicationUpdate(StatusEnum status, SuccessResponseApplicationUpdateData data) {
    this.status = status;
    this.data = data;
  }
  ...
  */
  ...
  @JsonProperty("data")
  public SuccessResponseApplicationUpdateData getData() {
    return data;
  }
