...
public class PersistAuthorizedConsentApiController implements PersistAuthorizedConsentApi {

    private final NativeWebRequest request;

    @Autowired
    public PersistAuthorizedConsentApiController(NativeWebRequest request) {
