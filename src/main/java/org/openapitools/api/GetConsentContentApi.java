...
public interface GetConsentContentApi {
    ...
    /**
     * POST /get-consent-content : Handle GET consent content requests from AISP
     *
    ...
    @Operation(
        ...
        summary = "Handle GET consent content requests from AISP",
        tags = { "Consent" },
        responses = {
            @ApiResponse(responseCode = "200", description = "Ok", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = Response200ForGetConsentContent.class))
            }),
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"data\" : { \"consentContent\" : \"{}\", \"responseHeaders\" : \"{}\" }, \"responseId\" : \"responseId\", \"status\" : \"SUCCESS\" }";
