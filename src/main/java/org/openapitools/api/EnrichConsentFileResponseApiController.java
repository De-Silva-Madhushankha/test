...
public class EnrichConsentFileResponseApiController implements EnrichConsentFileResponseApi {

    private final NativeWebRequest request;

    @Autowired
    public EnrichConsentFileResponseApiController(NativeWebRequest request) {
