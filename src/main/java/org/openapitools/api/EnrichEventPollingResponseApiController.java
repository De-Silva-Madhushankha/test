...
public class EnrichEventPollingResponseApiController implements EnrichEventPollingResponseApi {

    private final NativeWebRequest request;

    @Autowired
    public EnrichEventPollingResponseApiController(NativeWebRequest request) {
