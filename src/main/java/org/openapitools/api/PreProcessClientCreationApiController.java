...
public class PreProcessClientCreationApiController implements PreProcessClientCreationApi {

    private final NativeWebRequest request;

    @Autowired
    public PreProcessClientCreationApiController(NativeWebRequest request) {
