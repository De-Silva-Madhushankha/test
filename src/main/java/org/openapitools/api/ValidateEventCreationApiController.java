...
import org.openapitools.model.EventCreationRequestBody;
...
public class ValidateEventCreationApiController implements ValidateEventCreationApi {

    private final NativeWebRequest request;

    @Autowired
    public ValidateEventCreationApiController(NativeWebRequest request) {
