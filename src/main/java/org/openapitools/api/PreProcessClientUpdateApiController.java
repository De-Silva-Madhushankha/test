...
public class PreProcessClientUpdateApiController implements PreProcessClientUpdateApi {

    private final NativeWebRequest request;

    @Autowired
    public PreProcessClientUpdateApiController(NativeWebRequest request) {
