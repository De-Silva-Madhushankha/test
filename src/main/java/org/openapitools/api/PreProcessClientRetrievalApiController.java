...
public class PreProcessClientRetrievalApiController implements PreProcessClientRetrievalApi {

    private final NativeWebRequest request;

    @Autowired
    public PreProcessClientRetrievalApiController(NativeWebRequest request) {
