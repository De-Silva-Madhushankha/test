...
public class PreProcessApplicationCreationApiController implements PreProcessApplicationCreationApi {

    private final NativeWebRequest request;

    @Autowired
    public PreProcessApplicationCreationApiController(NativeWebRequest request) {
