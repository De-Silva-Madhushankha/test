...
public class MapAcceleratorErrorResponseApiController implements MapAcceleratorErrorResponseApi {

    private final NativeWebRequest request;

    @Autowired
    public MapAcceleratorErrorResponseApiController(NativeWebRequest request) {
