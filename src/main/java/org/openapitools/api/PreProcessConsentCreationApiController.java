...
public class PreProcessConsentCreationApiController implements PreProcessConsentCreationApi {

    private final NativeWebRequest request;

    @Autowired
    public PreProcessConsentCreationApiController(NativeWebRequest request) {
