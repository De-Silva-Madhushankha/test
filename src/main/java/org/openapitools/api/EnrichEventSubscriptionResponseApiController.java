...
public class EnrichEventSubscriptionResponseApiController implements EnrichEventSubscriptionResponseApi {

    private final NativeWebRequest request;

    @Autowired
    public EnrichEventSubscriptionResponseApiController(NativeWebRequest request) {
