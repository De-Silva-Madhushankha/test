...
@JsonTypeName("GetConsentContentRequestBody")
...
public class GetConsentContentRequestBody {
  ...
  @JsonProperty("data")
  private GetConsentContentData data;
  ...
  */
  ...
  public GetConsentContentRequestBody data(GetConsentContentData data) {
    this.data = data;
    return this;
  }
  ...
  */
  ...
  public GetConsentContentData getData() {
    return data;
  }

  public void setData(GetConsentContentData data) {
    this.data = data;
  }
